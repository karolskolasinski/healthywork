  ...
  <div class="max-w-7xl mx-auto px-4 md:px-16 py-10 md:pt-20 md:pb-0">
    <div class="flex flex-col lg:flex-row gap-16 pb-8">
      <div class="flex-1 flex flex-col gap-2">
        <a href="/healthywork/" class="flex gap-2 items-center w-fit">
          <img src="/healthywork/img/logo.svg" alt="logo" class="w-6 xs:w-7 brightness-0 invert" />
      ...
      <div class="flex flex-col gap-4 flex-1">
        ...
        <div class="flex gap-2 items-center">
          <img src="/healthywork/img/email.svg" alt="logo" class="w-6 xs:w-7 brightness-0 invert" />
        ...
        <div class="flex gap-2 items-center">
          <img src="/healthywork/img/phone.svg" alt="logo" class="w-6 xs:w-7 brightness-0 invert" />
          +48 000 000 000
        </div>

        <div class="flex gap-2 items-start">
          <img src="/healthywork/img/address.svg" alt="logo" class="w-6 xs:w-7 brightness-0 invert" />
